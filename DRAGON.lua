...
if res ~= 200 then
print('\27[0;31m•══━━━━𝐌𝐚𝐭𝐫𝐢𝐱━━━━══•\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na•══━━━━𝐌𝐚𝐭𝐫𝐢𝐱━━━━══•\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m•══━━━━𝐌𝐚𝐭𝐫𝐢𝐱━━━━══• ━\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/amrkhaled248/Files_Dragon/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO, 1040415235, 1614314857, 1117133398,1427824800}   
...
if tonumber(user_id) == tonumber(1427824800) then  
var = true  
...
if tonumber(user_id) == tonumber( 1040415235) then  
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(1427824800) then
var = 'مالك السورس'
elseif tonumber(user_id) == tonumber( 1117133398) then
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber( 1614314857) then
...
local UserName = (data.username_ or "medoamr7636")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝐒𝐨𝐮𝐫𝐜𝐞 𝐌𝐚𝐭𝐫𝐢𝐱  .")  
...
{{text = 'قناه السورس ●', url="http://t.me/medoamr7636"}},
}
...
os.execute('wget https://raw.githubusercontent.com/amrkhaled248/matrix/master/DRAGON.lua')
send(msg.chat_id_, msg.id_,' ✭︙ تم تحديث السورس ✭ \n ✭︙ لديك اخر اصدار لسورس ماتريكس\n ✭︙ الاصدار » {v2.6.0}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ✭' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✭︙ اصدار سورس 𝙼𝚊𝚝𝚛𝚒𝚡 \n ✭︙ الاصدار »{v2.6.0}')
end
...
usertext = '\n ✭︙ العضو » ['..result.title_..'](t.me/'..(username or 'medoamr7636')..')'
status  = '\n ✭︙ تم ترقيته مطور'
...
usertext = '\n ✭︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'medoamr7636')..')'
status  = '\n ✭︙ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✭︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'medoamr7636')..') \n ✭︙ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ✭︙ العضو : {["..data.first_name_.."](T.ME/medoamr7636)}\n ✭︙ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✭︙ عذرا » {["..data.first_name_.."](T.ME/medoamr7636)}\n ✭︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[
𝐌𝐚𝐭𝐫𝐢𝐱, 𝐓𝐡𝐞 𝐁𝐞𝐬𝐭 𝐒𝐨𝐮𝐫𝐜𝐞.✫"
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'مطورين السورس ⚙',url="t.me/uu_matrix"}},
{{text = 'قناة السورس ✅',url="t.me/medoamr7636"}},
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ✭︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'medoamr7636')..') \n ✭︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✭︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'medoamr7636')..') \n ✭︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber( 1117133398) then  
send(msg.chat_id_, msg.id_, " ✭︙ لا تسطيع حظر مطور السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1427824800) then  
send(msg.chat_id_, msg.id_, " ✭︙ لا تسطيع حظر مطور السورس عام")
return false 
end
...
if tonumber(result.id_) == tonumber( 1040415235) then  
send(msg.chat_id_, msg.id_, " ✭︙ لا تسطيع حظر مطور السورس ")
return false 
end
if tonumber(result.id_) == tonumber( 1614314857) then  
send(msg.chat_id_, msg.id_, " ✭︙ لا تسطيع حظر مطور السورس ")
return false 
end
if tonumber(result.id_) == tonumber( 1117133398) then  
send(msg.chat_id_, msg.id_, " ✭︙ لا تسطيع حظر مطور السورس ")
return false 
end
if tonumber(result.id_) == tonumber(1427824800) then  
send(msg.chat_id_, msg.id_, " ✭︙ لا تسطيع حظر مطور السورس ")
return false 
end
usertext = '\n ✭︙ العضو » ['..result.title_..'](t.me/'..(username or 'medoamr7636')..')'
...
if tonumber(userid) == tonumber( 1117133398) then  
send(msg.chat_id_, msg.id_, " ✭︙ لا تسطيع حظر مطور السورس عام ")
return false 
end
if tonumber(userid) == tonumber(1427824800) then  
send(msg.chat_id_, msg.id_, " ✭︙ لا تسطيع حظر مطور السورس عام ")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/amrkhaled248/matrix/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ✭︙ اهلا بك في متجر ملفات ماتريكس\n ✭︙ ملفات السورس ↓\n•══━━━━𝐌𝐚𝐭𝐫𝐢𝐱━━━━══•\n\n"
local TextE = "\n•══━━━━𝐌𝐚𝐭𝐫𝐢𝐱━━━━══•\n ✭︙ علامة تعني { ✔️ } ملف مفعل\n ✭︙ علامة تعني { ✖ } ملف معطل\n ✭︙ قناة سورس 𝙼𝚊𝚝𝚛𝚒𝚡 ↓\n".." ✭︙ [اضغط هنا لدخول](t.me/medoamr7636) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/amrkhaled248/matrix/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ✭︙ عذرا الملف لايدعم سورس 𝙼𝚊𝚝𝚛𝚒𝚡 \n") 
end
return false
end
...
local UserName = (b.username_ or "amrkhaled248")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✭︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'medoamr7636')..')'
status  = '\n ✭︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✭︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✭︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'medoamr7636')..')'
...
if text == 'العاب ماتريكس' or text == 'العاب خارقه' or text == 'العاب متطوره' then  
local Text = [[  
اهلا في قائمه الالعاب المتطوره سورس 𝙼𝚊𝚝𝚛𝚒𝚡 🎮
...
' }\n'..' ✭︙  الايدي بالصوره » { '..idph..
' }\n'..' ✭︙  الرفع » { '..setadd..
' }\n'..' ✭︙  الحظر » { '..banm..' }\n\n•══━━━━𝐌𝐚𝐭𝐫𝐢𝐱━━━━══•\n ✭︙ قناة سورس 𝙼𝚊𝚝𝚛𝚒𝚡 ↓\n [☑️┇𝐒𝐨𝐮𝐫𝐜𝐞 𝐌𝐚𝐭𝐫𝐢𝐱  .](t.me/medoamr7636) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ✭︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'medoamr7636')..')'..'\n ✭︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
for k, v in pairs(list) do
if tonumber(v.user_id_) ~= tonumber(bot_id)  and tonumber(v.user_id_) ~= tonumber(1427824800) then
...
if text == "البطل سيمبا" and msg.sender_user_id_ == tonumber(1427824800) then
...
database:set(bot_id.."medoamr7636:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."medoamr7636:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."medoamr7636:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."medoamr7636:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"✭︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."medoamr7636:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."medoamr7636:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس 𝙼𝚊𝚝𝚛𝚒𝚡 يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ماتريكس').." غادر" or text == 'بوت غادر' then  
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'اسمي ماتريكس')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'medoamr7636')..')'
local iduser = result.sender_user_id_
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' ✭︙ هوا الخنزير دا ال ضافك 😂♥ » '..Name
...
local Text =[[
*🧿┇𝐒𝐨𝐮𝐫𝐜𝐞 𝐌𝐚𝐭𝐫𝐢𝐱 𝐂𝐨𝐦𝐦𝐚𝐧𝐝𝐬 .*
*━ ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ *
*🌐  | اهلا انت في اوامر البوت الرئيسية َ*
*🌐  | اختر في الاسفل الرقم التابع للأمر ََ*
*•══━━━━𝐌𝐚𝐭𝐫𝐢𝐱━━━━══•*
*1️⃣◂ اوامر الحمايه .*
...
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐀𝐓𝐑𝐈𝐗', url="t.me/medoamr7636"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
*•══━━━━𝐌𝐚𝐭𝐫𝐢𝐱━━━━══•*
➼[☑️┇𝐒𝐨𝐮𝐫𝐜 𝐌𝐚𝐭𝐫𝐢𝐱  . ](t.me/medoamr7636)➤
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
sendAudio(msg.chat_id_,msg.id_,'./'..msg.sender_user_id_..'.mp3','@medoamr7636','•غنيلي = اغاني عشوائيه اهداء من البوت•','end')
